...
class MixpanelBaseProducerTest extends PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		parent::setUp();
		$this->_file     = __DIR__ . '/output-' . time() . '.txt';
		$this->_instance = new _Producers_MixpanelBaseProducer(
			'token',
			array(
				'consumer' => 'file',
				'debug'    => true,
	...
	public function testFlush() {
		$event1 = array(
			'event'      => 'test',
			'properties' => array( 'prop1' => 'val1' ),
		);
		$event2 = array(
			'event'      => 'test2',
			'properties' => array( 'prop2' => 'val2' ),
		);
		...
		$this->assertEquals(
			'[{"event":"test","properties":{"prop1":"val1"}}]' . "\n" .
